<template>
    <section>
        ...
        <section class="mid-body-box">
            <router-view v-if="isPage == '1' || $route.name == 'enterprise'"></router-view>
            <div v-if="isPage == '0' && !$route.name == 'enterprise'" class="null-register">
                请您先去
                <router-link class="nav-registor" :to="{name: 'enterprise'}">
