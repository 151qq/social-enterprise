...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_common_upload__ = __webpack_require__(243);
    ...
    methods: {
        getBase: function getBase() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].request({
                ...
                if (res.result.success == '1') {
                    var result = res.result.result;
                    _this.quanData = result.couponInfo;

                    if (result.couponProduct) {
                        _this.couponProduct = result.couponProduct;
                    }

                    if (result.couponDeducationRule) {
                        _this.couponDeducationRule = result.couponDeducationRule;
                    }

                    if (result.couponGifeRule) {
                        _this.couponGifeRule = result.couponGifeRule;
                    }
                } else {
        ...
        getProducts: function getProducts() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].request({
                ...
                if (res.result.success == '1') {
                    _this2.products = res.result.result;
                } else {
        ...
        getGifts: function getGifts() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].request({
                ...
                if (res.result.success == '1') {
                    _this3.giftLists = res.result.result;
                } else {
        ...
        getTypes: function getTypes() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].request({
                ...
                if (res.result.success == '1') {
                    _this4.useSceneList = res.result.result.coupon_scenario;
                } else {
                    _this4.$message.error(res.result.message);
                }
            });
        },
        getCouponTypes: function getCouponTypes() {
            var _this5 = this;
            ...
            __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].request({
                ...
                if (res.result.success == '1') {
                    _this5.couponTypes = res.result.result;
                } else {
        ...
        saveQuan: function saveQuan() {
            ...
            if (this.quanData.couponPublishTime) {
                this.quanData.couponPublishTime = __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].formDataDate(this.quanData.couponPublishTime);
            }

            if (this.quanData.couponEndTime) {
                this.quanData.couponEndTime = __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].formDataDate(this.quanData.couponEndTime);
            }
            ...
            if (this.couponProduct.productCode) {
                formData.couponProduct = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(this.couponProduct, codeData);
            } else {
            ...
            if (this.couponDeducationRule.couponConsumeAmount || this.couponDeducationRule.couponDeducationNumber) {
                formData.couponDeducationRule = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(this.couponDeducationRule, codeData);
            } else {
                delete formData.couponDeducationRule;
            }

            if (this.couponGifeRule.giftCode) {
                formData.couponGifeRule = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(this.couponGifeRule, codeData);
            } else {
            ...
            __WEBPACK_IMPORTED_MODULE_1__assets_common_util__["a" /* default */].request({
                ...
                if (res.result.success == '1') {
                    ...
                    var pathObj = {
                        name: 'market-detail',
                        query: {
                            eventCode: _this6.$route.query.eventCode,
                            enterprise: _this6.$route.query.enterpriseCode
                        }
                    };

                    _this6.$router.push(pathObj);
                } else {
                    _this6.$message.error(res.result.msg);
                }
            });
        }
    },
    components: {
        upload: __WEBPACK_IMPORTED_MODULE_2__components_common_upload___default.a
    }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "formBox"
  }, [_c('span', [_vm._v("券标题")]), _vm._v(" "), _c('el-input', {
    staticClass: "input-box",
    attrs: {
      "placeholder": "请输入标题"
    },
    model: {
      value: (_vm.quanData.couponTitle),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponTitle", $$v)
      },
      expression: "quanData.couponTitle"
    }
  })], 1), _vm._v(" "), _c('section', {
    staticClass: "formBox"
  }, [_c('span', [_vm._v("券类型")]), _vm._v(" "), _c('el-select', {
    staticClass: "input-box",
    attrs: {
      "disabled": true,
      "placeholder": "请选择"
    ...
    model: {
      value: (_vm.quanData.couponType),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponType", $$v)
      },
      expression: "quanData.couponType"
    }
    ...
    staticClass: "formBox"
  }, [_c('span', [_vm._v("使用场景")]), _vm._v(" "), _c('el-select', {
    staticClass: "input-box",
    attrs: {
      "placeholder": "请选择"
    },
    model: {
      value: (_vm.quanData.couponScenario),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponScenario", $$v)
      },
      expression: "quanData.couponScenario"
    }
  }, _vm._l((_vm.useSceneList), function(item, index) {
    return _c('el-option', {
      key: index,
      attrs: {
        "label": item.typeName,
    ...
    staticClass: "formBox"
  }, [_c('span', [_vm._v("适用产品")]), _vm._v(" "), _c('el-select', {
    staticClass: "input-box",
    attrs: {
      "filterable": "",
      "allow-create": "",
    ...
    model: {
      value: (_vm.couponProduct.productCode),
      callback: function($$v) {
        _vm.$set(_vm.couponProduct, "productCode", $$v)
      },
      expression: "couponProduct.productCode"
    }
    ...
    model: {
      value: (_vm.quanData.couponPublishTime),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponPublishTime", $$v)
      },
      expression: "quanData.couponPublishTime"
    }
  })], 1), _vm._v(" "), _c('section', {
    staticClass: "formBox"
    ...
    model: {
      value: (_vm.quanData.couponEndTime),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponEndTime", $$v)
      },
      expression: "quanData.couponEndTime"
    }
  })], 1), _vm._v(" "), _c('section', {
    staticClass: "formBox bigF"
  }, [_c('span', [_vm._v("使用须知")]), _vm._v(" "), _c('el-input', {
    attrs: {
      "type": "textarea",
      "rows": 4,
      "maxlength": 140,
    ...
    model: {
      value: (_vm.quanData.couponExchangeRule),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponExchangeRule", $$v)
      },
      expression: "quanData.couponExchangeRule"
    }
  })], 1), _vm._v(" "), _c('section', {
    staticClass: "formBox bigF"
  }, [_c('span', [_vm._v("券封面")]), _vm._v(" "), _c('div', {
    staticClass: "input-box"
  }, [_c('upload', {
    attrs: {
      "path": _vm.quanData.couponCover,
      "bg-path": true
    },
    on: {
    ...
    staticClass: "formBox"
  }, [_c('span', [_vm._v("封面标题")]), _vm._v(" "), _c('el-input', {
    staticClass: "input-box",
    attrs: {
      "placeholder": "请输入券封面标题"
    },
    model: {
      value: (_vm.quanData.couponCoverTxt),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponCoverTxt", $$v)
      },
      expression: "quanData.couponCoverTxt"
    }
  })], 1), _vm._v(" "), _c('section', {
    staticClass: "formBox"
  }, [_c('span', [_vm._v("券数量")]), _vm._v(" "), _c('el-input', {
    staticClass: "input-box",
    attrs: {
      "type": "number",
      "min": "0",
    ...
    model: {
      value: (_vm.quanData.couponTotalInventory),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponTotalInventory", $$v)
      },
      expression: "quanData.couponTotalInventory"
    }
  })], 1), _vm._v(" "), _c('section', {
    staticClass: "formBox"
  }, [_c('span', [_vm._v("核销提示")]), _vm._v(" "), _c('el-input', {
    staticClass: "input-box",
    attrs: {
      "placeholder": "请输入标题，最多9个字"
    },
    model: {
      value: (_vm.quanData.couponExchangeTxt),
      callback: function($$v) {
        _vm.$set(_vm.quanData, "couponExchangeTxt", $$v)
      },
      expression: "quanData.couponExchangeTxt"
    }
  })], 1), _vm._v(" "), (_vm.quanData.couponType == 'cashCoupon') ? [_c('section', {
    staticClass: "formBox"
  }, [_c('span', [_vm._v("消费满")]), _vm._v(" "), _c('el-input', {
    staticClass: "input-box",
    attrs: {
      "type": "number",
      "min": "0",
    ...
    model: {
      value: (_vm.couponDeducationRule.couponConsumeAmount),
      callback: function($$v) {
        _vm.$set(_vm.couponDeducationRule, "couponConsumeAmount", $$v)
      },
      expression: "couponDeducationRule.couponConsumeAmount"
    }
  })], 1), _vm._v(" "), _c('section', {
    staticClass: "formBox"
  }, [_c('span', [_vm._v("减免")]), _vm._v(" "), _c('el-input', {
    staticClass: "input-box",
    attrs: {
      "type": "number",
      "min": "0",
    ...
    model: {
      value: (_vm.couponDeducationRule.couponDeducationNumber),
      callback: function($$v) {
        _vm.$set(_vm.couponDeducationRule, "couponDeducationNumber", $$v)
      },
      expression: "couponDeducationRule.couponDeducationNumber"
    }
  })], 1)] : _vm._e(), _vm._v(" "), (_vm.quanData.couponType == 'giftCoupon') ? [_c('section', {
    staticClass: "formBox"
  }, [_c('span', [_vm._v("礼品")]), _vm._v(" "), _c('el-select', {
    staticClass: "input-box",
    attrs: {
      "placeholder": "请选择"
    },
    model: {
      value: (_vm.couponGifeRule.giftCode),
      callback: function($$v) {
        _vm.$set(_vm.couponGifeRule, "giftCode", $$v)
      },
      expression: "couponGifeRule.giftCode"
    }
  }, _vm._l((_vm.giftLists), function(item, index) {
    return _c('el-option', {
      key: index,
      attrs: {
        "label": item.label,
