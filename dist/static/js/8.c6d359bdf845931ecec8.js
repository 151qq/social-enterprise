    ...
    methods: {
        ...
        getList: function getList(type) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__assets_common_util__["a" /* default */].request({
                ...
                if (!type) {
                    _this.marketList = res.result.result;
                } else {
                    _this.marketList = _this.marketList.concat(res.result.result);
                }
            });
        },
        changeStatus: function changeStatus(item, type) {
            var _this2 = this;
        ...
        deleteItemByCode: function deleteItemByCode(item) {
            var _this3 = this;
        ...
        confirmItem: function confirmItem() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__assets_common_util__["a" /* default */].request({
                ...
                if (res.result.success == '1') {
                    _this4.pageNumber = 1;
                    _this4.getList();
                    _this4.isAddItem = false;

                    window.open('/#/marketDetail?enterpriseCode=' + _this4.$route.query.enterpriseCode + '&eventCode=' + res.result.result, '_blank');
                } else {
...
// module
exports.push([module.i, ".market-list-box{width:1000px;margin:80px auto 30px}.market-list-box .input-box{display:block;width:800px;height:50px;margin:0 auto 30px}.market-list-box .input-box .el-input{float:left;width:600px;height:50px}.market-list-box .input-box .el-input input{font-size:14px;height:50px}.market-list-box .input-box .search-btn{position:relative;float:left;margin-left:-10px;border-top-left-radius:0;border-bottom-left-radius:0;height:50px;font-size:16px;padding:0 23px}.market-list-box .input-box .add-new-btn{float:right;height:50px}.market-list-box .big-cards-box .card-btns{text-align:right;position:absolute;font-size:16px;color:#000;right:10px;bottom:23px}.market-list-box .big-cards-box .card-box{position:relative;display:block;overflow:hidden;padding-bottom:20px;border-bottom:1px solid #c0ccda;margin-bottom:20px}.market-list-box .big-cards-box .card-box .card-img{float:left;width:200px;height:120px;background:#cfcfd0}.market-list-box .big-cards-box .card-box .card-img img{display:block;width:200px;height:120px}.market-list-box .big-cards-box .card-box .card-content{float:right;width:780px}.market-list-box .big-cards-box .card-box .card-content .card-title{font-size:18px;line-height:30px;color:#000}.market-list-box .big-cards-box .card-box .card-content .card-desc{font-size:14px;line-height:24px;color:#475669;height:48px;margin-top:10px;overflow:hidden}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(163)("2897412e", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("增加")])], 1), _vm._v(" "), _c('section', {
    staticClass: "big-cards-box"
    ...
    }, [(item.eventPlanCover) ? _c('img', {
      attrs: {
        "src": item.eventPlanCover
      }
    }) : _vm._e()]), _vm._v(" "), _c('div', {
      staticClass: "card-content"
    }, [_c('div', {
      staticClass: "card-title"
    }, [_vm._v(_vm._s(item.eventPlanTitle))]), _vm._v(" "), _c('div', {
      staticClass: "card-desc"
    }, [_vm._v(_vm._s(item.eventPlanDesc))]), _vm._v(" "), _c('div', {
      staticClass: "card-tag"
    }, [(item.eventPlanStatus == 'draft') ? _c('el-tag', {
      attrs: {
        "type": "gray"
      }
    }, [_vm._v("草稿")]) : _vm._e(), _vm._v(" "), (item.eventPlanStatus == 'submitted') ? _c('el-tag', {
      attrs: {
        "type": "success"
      }
    }, [_vm._v("已发布")]) : _vm._e(), _vm._v(" "), (item.eventPlanStatus == 'end') ? _c('el-tag', [_vm._v("正常结束")]) : _vm._e(), _vm._v(" "), (item.eventPlanStatus == 'closed') ? _c('el-tag', [_vm._v("提前终止")]) : _vm._e()], 1)]), _vm._v(" "), _c('section', {
      staticClass: "card-btns"
    }, [(item.eventPlanStatus == 'draft') ? _c('i', {
      staticClass: "el-icon-upload2",
      on: {
        "click": function($event) {
          $event.stopPropagation();
          _vm.changeStatus(item, 'submitted')
        }
      }
    }) : _vm._e(), _vm._v(" "), (item.eventPlanStatus == 'draft') ? _c('i', {
  ...
  })), _vm._v(" "), (_vm.total && _vm.marketList.length < _vm.total) ? _c('div', {
    staticClass: "more-load",
    on: {
      "click": _vm.loadMore
    }
  }, [_vm._v("加载更多...")]) : _vm._e(), _vm._v(" "), _c('el-dialog', {
    attrs: {
      "title": "添加方案",
    ...
    model: {
      value: (_vm.addItemForm.eventPlanTitle),
      callback: function($$v) {
        _vm.$set(_vm.addItemForm, "eventPlanTitle", $$v)
      },
      expression: "addItemForm.eventPlanTitle"
    }
    ...
    attrs: {
      "path": _vm.addItemForm.eventPlanCover,
      "is-operate": true,
      "bg-path": true
    },
    on: {
    ...
    model: {
      value: (_vm.addItemForm.eventPlanDesc),
      callback: function($$v) {
        _vm.$set(_vm.addItemForm, "eventPlanDesc", $$v)
      },
      expression: "addItemForm.eventPlanDesc"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "dialog-footer",
    attrs: {
